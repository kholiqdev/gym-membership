...
type OfflineClassBookingResponse struct {
	...
	OfflineClassBookingDetail []*OfflineClassBookingDetailResponse `json:"offline_class_booking_detail,omitempty"`
	CreatedAt                 time.Time                            `json:"created_at,omitempty"`
	UpdatedAt                 time.Time                            `json:"updated_at,omitempty"`
}

type OfflineClassBookingListResponse []*OfflineClassBookingResponse

type OfflineClassBookingDetailResponse struct {
	ID               uint      `json:"id,omitempty"`
